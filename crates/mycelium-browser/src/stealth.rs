...
//!
//! ```
//! use mycelium_browser::stealth::{NavigatorProfile, StealthConfig, StealthProfile};
//!
...
///
/// ```
/// use mycelium_browser::stealth::StealthConfig;
...
///
/// ```
/// use mycelium_browser::stealth::NavigatorProfile;
...
/// #     config: &mycelium_browser::BrowserConfig,
/// # ) -> mycelium_browser::Result<()> {
/// use mycelium_browser::stealth::apply_stealth_to_page;
