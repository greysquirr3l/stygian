...
//!
//! ```
//! use mycelium_browser::fingerprint::{Fingerprint, inject_fingerprint};
//!
...
///
/// ```
/// use mycelium_browser::fingerprint::Fingerprint;
///
/// let fp = Fingerprint::random();
...
impl Fingerprint {
    ...
    ///
    /// ```
    /// use mycelium_browser::fingerprint::{Fingerprint, FingerprintProfile};
    ///
    ...
    ///
    /// ```
    /// use mycelium_browser::fingerprint::{Fingerprint, DeviceProfile};
    ///
...
///
/// ```
/// use mycelium_browser::fingerprint::FingerprintProfile;
///
...
///
/// ```
/// use mycelium_browser::fingerprint::DeviceProfile;
///
...
///
/// ```
/// use mycelium_browser::fingerprint::{BrowserKind, DeviceProfile};
///
