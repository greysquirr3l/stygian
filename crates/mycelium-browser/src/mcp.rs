...
//!
//! Exposes `mycelium-browser` capabilities as an MCP server over stdin/stdout
...
//! ```toml
//! [dependencies]
//! mycelium-browser = { version = "0.1", features = ["mcp"] }
//! ```
//!
//! ## Running the server
//!
//! ```sh
//! MYCELIUM_MCP_ENABLED=true cargo run --example mcp_server -p mycelium-browser
//! ```
//!
//! ## Protocol
//!
...
/// use mycelium_browser::mcp::McpBrowserServer;
/// use std::sync::Arc;
///
