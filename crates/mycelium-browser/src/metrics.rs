//! Performance metrics for mycelium-browser.
//!
...
//! ```toml
//! [dependencies]
//! mycelium-browser = { version = "0.1", features = ["metrics"] }
//! ```
//!
//! ## Example
//!
//! ```no_run
//! use mycelium_browser::metrics::{gather, METRICS};
//!
...
///
/// ```
/// use mycelium_browser::metrics::gather;
/// let text = gather();
