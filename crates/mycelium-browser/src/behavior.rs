...
///
/// # async fn run(page: &chromiumoxide::Page) -> mycelium_browser::Result<()> {
...
///
/// ```
/// use mycelium_browser::behavior::InteractionLevel;
...
/// ```no_run
/// # async fn run(page: &chromiumoxide::Page) -> mycelium_browser::Result<()> {
/// use mycelium_browser::behavior::{InteractionSimulator, InteractionLevel};
