...
//!
//! ```no_run
//! use mycelium_graph::application::api_server::ApiServer;
//!
//! #[tokio::main]
...
///
/// ```
/// use mycelium_graph::application::api_server::PipelineState;
///
...
///
/// ```no_run
/// use mycelium_graph::application::api_server::{build_router, AppState};
///
...
impl ApiServer {
    ...
    pub async fn run(self, addr: &str) -> Result<(), Box<dyn std::error::Error>> {
        ...
        info!(address = %addr, "mycelium-api listening");
...
<nav class="bg-indigo-700 text-white px-6 py-4 flex items-center gap-3 shadow-md">
  ...
  <h1 class="text-xl font-bold tracking-tight">Mycelium</h1>
