...
///
/// ```
/// use mycelium_graph::adapters::wasm_plugin::MockWasmPlugin;
/// use mycelium_graph::ports::wasm_plugin::WasmPluginPort;
/// use std::path::PathBuf;
///
...
mod real {
    ...
    ///
    /// ```no_run
    /// use mycelium_graph::adapters::wasm_plugin::WasmPluginLoader;
    /// use mycelium_graph::ports::wasm_plugin::WasmPluginPort;
    /// use std::path::PathBuf;
    ///
    /// # tokio_test::block_on(async {
