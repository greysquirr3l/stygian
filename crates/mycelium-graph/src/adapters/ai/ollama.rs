...
//!
//! ```no_run
//! use mycelium_graph::adapters::ai::ollama::{OllamaProvider, OllamaConfig};
...
impl OllamaProvider {
    ...
    fn map_http_error(status: u16, body: &str) -> MyceliumError {
        match status {
            404 => MyceliumError::Provider(ProviderError::ModelUnavailable(format!(
...
mod tests {
    ...
    fn test_map_http_error_404() {
        assert!(matches!(
            ...
            MyceliumError::Provider(ProviderError::ModelUnavailable(_))
        ));
    }
