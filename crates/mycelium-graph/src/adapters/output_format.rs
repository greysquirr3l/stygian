...
///
/// ```
/// use mycelium_graph::adapters::output_format::JsonlFormatter;
/// use mycelium_graph::ports::storage::{OutputFormatter, StorageRecord};
/// use serde_json::json;
///
...
///
/// ```
/// use mycelium_graph::adapters::output_format::JsonFormatter;
/// use mycelium_graph::ports::storage::{OutputFormatter, StorageRecord};
/// use serde_json::json;
///
...
///
/// ```
/// use mycelium_graph::adapters::output_format::CsvFormatter;
/// use mycelium_graph::ports::storage::{OutputFormatter, StorageRecord};
/// use serde_json::json;
///
...
///
/// ```
/// use mycelium_graph::adapters::output_format::{formatter_for, CsvFormatter};
