...
///
/// ```no_run
/// use mycelium_graph::ports::{ScrapingService, ServiceInput, ServiceOutput};
/// use mycelium_graph::error::Result;
/// use async_trait::async_trait;
/// use serde_json::json;
///
/// struct MyService;
...
pub trait ScrapingService: Send + Sync {
    ...
    /// * `Err(MyceliumError)` - Service error, timeout, or network failure
    ///
    /// # Example
    ///
    /// ```no_run
...
///
/// ```
/// use mycelium_graph::ports::ProviderCapabilities;
///
...
///
/// ```no_run
/// use mycelium_graph::ports::{AIProvider, ProviderCapabilities};
...
///
/// ```no_run
/// use mycelium_graph::ports::CachePort;
/// use mycelium_graph::domain::error::Result;
/// use async_trait::async_trait;
...
///
/// ```
/// use mycelium_graph::ports::CircuitState;
///
...
///
/// ```
/// use mycelium_graph::ports::RateLimitConfig;
/// use std::time::Duration;
///
